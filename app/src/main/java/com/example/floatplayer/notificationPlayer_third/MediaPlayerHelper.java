...
//            onPlayFromUri(uri, null);
    ...
    private void updateNotification() {
        NotificationCompat.Action playPauseAction =
                ...
                createAction(R.drawable.ic_baseline_pause_24, "Pause", AudioPlayerService.ACTION_PAUSE) :
                createAction(R.drawable.ic_baseline_play_arrow_24, "Play", AudioPlayerService.ACTION_PLAY);
        ...
        NotificationCompat.Builder notificationCompat = new NotificationCompat.Builder(mContext)
                ...
                .addAction(createAction(R.drawable.ic_baseline_skip_next_24, "next",
...
//                mediaPlayer在播放并且seebar没有被按下
    ...
    public void setPlayData(List<MusicEntity> list_data) {
    ...
    private MediaMetadataCompat getMusicEntity(String musicName, String Singer, String album) {
        ...
        //歌手
        mediaMetadataCompat.getBundle().putString(MediaMetadataCompat.METADATA_KEY_AUTHOR, Singer);
        //专辑
        mediaMetadataCompat.getBundle().putString(MediaMetadataCompat.METADATA_KEY_ALBUM, album);
        //title
        mediaMetadataCompat.getBundle().putString(MediaMetadataCompat.METADATA_KEY_TITLE, musicName);
